...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'VLSSY Inter College - Excellence in Education'); ?></title>
...
<body>
    <header>
        <nav>
            <a href="<?php echo e(route('home')); ?>" class="logo">
                <img src="<?php echo e(asset('public/images/vlssy-1.jpg')); ?>" alt="VLSSY Inter College Logo" class="logo-image">
            </a>
            ...
            <ul class="nav-links">
                ...
                <li><a href="<?php echo e(route('gallery')); ?>" class="<?php echo e(request()->routeIs('gallery') ? 'active' : ''); ?>">Gallery</a></li>
                <li><a href="<?php echo e(route('admission')); ?>" class="<?php echo e(request()->routeIs('admission') ? 'active' : ''); ?>">Admission</a></li>
                <li><a href="<?php echo e(route('facilities')); ?>" class="<?php echo e(request()->routeIs('facilities') ? 'active' : ''); ?>">Facilities</a></li>
                <li><a href="<?php echo e(route('examination')); ?>" class="<?php echo e(request()->routeIs('examination') ? 'active' : ''); ?>">Examination</a></li>
                <li><a href="<?php echo e(route('our-staff')); ?>" class="<?php echo e(request()->routeIs('our-staff') ? 'active' : ''); ?>">Our-Staff</a></li>
                <li><a href="https://lms.vlssy.com/" target="_blank">Online Learning</a></li>
                <li><a href="<?php echo e(route('our-blog')); ?>" class="<?php echo e(request()->routeIs('our-blog') ? 'active' : ''); ?>">Our-Blog</a></li>
                <li><a href="<?php echo e(route('contact')); ?>" class="<?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>">Contact US</a></li>
            </ul>
        </nav>
    </header>
    ...
    <script src="<?php echo e(asset('public/js/share-modal.js')); ?>"></script>
    <?php echo $__env->yieldContent('scripts'); ?>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\vlssycollege\resources\views/layout.blade.php ENDPATH**/ ?>